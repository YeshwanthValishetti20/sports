...
const Basketball = () => {
  ...
  useEffect(() => {
    axios
<<<<<<< HEAD
      .get("http://3.110.48.22:5000/api/auth/getMatches_bask")
=======
      .get("https://kreedacbit.onrender.com/api/auth/getMatches_bask")
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
    ...
    axios
<<<<<<< HEAD
      .get(`http://3.110.48.22:5000/api/auth/sportsItems/name/basketball`)
=======
      .get(`https://kreedacbit.onrender.com/api/auth/sportsItems/name/basketball`)
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
      .then((response) => {
...
<<<<<<< HEAD
      const response = await axios.put(`http://3.110.48.22:5000/api/auth/update-score_bask/${matchId}`, {
=======
      const response = await axios.put(`https://kreedacbit.onrender.com/api/auth/update-score_bask/${matchId}`, {
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
        team,
        score: newScore,
      });
  ...
  const handleAddMatch = () => {
    if (selectedMatch) {
      ...
      axios
        .put(
<<<<<<< HEAD
          `http://3.110.48.22:5000/api/auth/updateMatch_bask/${selectedMatch._id}`,
=======
          `https://kreedacbit.onrender.com/api/auth/updateMatch_bask/${selectedMatch._id}`,
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
          {
      ...
      axios
<<<<<<< HEAD
        .post("http://3.110.48.22:5000/api/auth/addMatch_bask", {
=======
        .post("https://kreedacbit.onrender.com/api/auth/addMatch_bask", {
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
          teamA: newMatch.teamA,
          teamB: newMatch.teamB,
          name: `${newMatch.teamA || "Team A"} VS ${
  ...
  const handleDeleteMatch = () => {
    if (selectedMatch) {
      axios
        .delete(
<<<<<<< HEAD
          `http://3.110.48.22:5000/api/auth/deleteMatch_bask/${selectedMatch._id}`
=======
          `https://kreedacbit.onrender.com/api/auth/deleteMatch_bask/${selectedMatch._id}`
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
        )
        .then(() => {
          setMatches(
  ...
  const handleRowClick = (match) => {
    ...
    axios
      .get(
<<<<<<< HEAD
        `http://3.110.48.22:5000/api/auth/getPlayers_bask/${match._id}?team=TeamA`
=======
        `https://kreedacbit.onrender.com/api/auth/getPlayers_bask/${match._id}?team=TeamA`
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
      )
    ...
    axios
      .get(
<<<<<<< HEAD
        `http://3.110.48.22:5000/api/auth/getPlayers_bask/${match._id}?team=TeamB`
=======
        `https://kreedacbit.onrender.com/api/auth/getPlayers_bask/${match._id}?team=TeamB`
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
      )
  ...
  const handleAddPlayer = () => {
    if (selectedMatch) {
      axios
        .post(
<<<<<<< HEAD
          `http://3.110.48.22:5000/api/auth/addPlayers_bask/${selectedMatch._id}`,
=======
          `https://kreedacbit.onrender.com/api/auth/addPlayers_bask/${selectedMatch._id}`,
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
          {
            ...playerFormData,
  ...
  const handleUpdatePlayer = () => {
    if (selectedMatch && selectedPlayerDetails) {
      ...
      axios
        .put(
<<<<<<< HEAD
          `http://3.110.48.22:5000/api/auth/updatePlayerDetails_bask/${matchId}/${playerId}`,
=======
          `https://kreedacbit.onrender.com/api/auth/updatePlayerDetails_bask/${matchId}/${playerId}`,
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
          {
  ...
  const handleDeletePlayer = () => {
    if (selectedPlayerDetails) {
      ...
      axios
        .delete(
<<<<<<< HEAD
          `http://3.110.48.22:5000/api/auth/deletePlayerDetails_bask/${playerId}/${matchId}`
=======
          `https://kreedacbit.onrender.com/api/auth/deletePlayerDetails_bask/${playerId}/${matchId}`
>>>>>>> a20fe5b1cae794c9adbbc456feb2c1ff89ca1dbf
        )
        .then(() => {
          const updatedPlayers =
